...
import { createCourseRequest } from "@/app/api/courses";
    ...
    <div className="min-h-screen bg-[#F7F9FC]">
      ...
      <div className="px-4 sm:px-6 lg:px-8 py-8 sm:py-10 max-w-5xl mx-auto">
        <div className="mb-6 sm:mb-8">
          <h1 className="text-h2 tracking-tight mb-2 text-[#0A1B39]">Create New Course</h1>
          <p className="text-sm text-[#676E85]">
            Set up the course details and upload the PDF material and cover image.
          </p>
        </div>
                ...
                <div className="bg-white p-6 rounded-xl border border-neutral-200 shadow-sm">
                  ...
                  <div className="rounded-xl border border-[#17A546]/30 overflow-hidden bg-white shadow-sm">
                    <div className="relative h-24 w-full bg-neutral-100 overflow-hidden">
                      <img 
                        src={coverImage ? URL.createObjectURL(coverImage) : "/img/hero_section.png"} 
