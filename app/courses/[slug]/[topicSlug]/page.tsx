...
import { ArrowLeft, PlayCircle, BookOpen, Brain, Trophy, ChevronRight, ChevronLeft } from "lucide-react";
import { Header } from "@/components/app_components/Header";
import { Footer } from "@/components/app_components/Footer";
import { Button } from "@/components/ui/button";
import ContrastText from "@/components/ui/ContrastText";
    ...
    <div className="flex min-h-screen flex-col bg-(--card)">
      ...
      <div className="bg-(--card) border-b border-border/60 sticky top-0 z-40 shadow-sm">
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          <Link href="/courses/ss1-physics" className="inline-flex items-center gap-2 text-[14px] font-medium text-(--muted) hover:text-(--heading) transition-colors group">
        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          ...
          <section className="bg-(--card) rounded-2xl sm:rounded-3xl border border-border/60 shadow-[0_4px_20px_-4px_rgba(0,0,0,0.03)] p-5 sm:p-10 mb-6 sm:mb-10">
            <div className="flex items-center gap-3 mb-5 sm:mb-8 pb-4 border-b border-border">
              ...
              <h2 className="text-[19px] sm:text-[22px] font-bold text-(--heading)">Theory & Explanations</h2>
            </div>
            ...
            <div className="prose prose-neutral max-w-none text-[#475467]">
              ...
              <h3 className="text-[17px] sm:text-[19px] font-bold text-(--heading) mt-6 sm:mt-8 mb-3 sm:mb-4">1. Distance and Displacement</h3>
              ...
              <div className="bg-(--card) p-4 sm:p-6 rounded-[12px] sm:rounded-2xl border border-border/60 my-6 sm:my-8">
                <h4 className="text-[14px] sm:text-[15px] font-bold text-(--heading) mb-3">Equations of Uniformly Accelerated Motion</h4>
          ...
          <section className="bg-(--card) rounded-[12px] sm:rounded-2xl border border-border/60 shadow-[0_4px_20px_-4px_rgba(0,0,0,0.03)] p-5 sm:p-10 mb-6 sm:mb-10">
            <div className="flex items-center gap-3 mb-5 sm:mb-8 pb-4 border-b border-border">
              ...
              <h2 className="text-[19px] sm:text-[22px] font-bold text-(--heading)">Worked Examples</h2>
            </div>
            ...
            <div className="space-y-5 sm:space-y-8">
              ...
              <div className="border border-border/60 rounded-[12px] sm:rounded-2xl overflow-hidden">
                <div className="bg-[rgba(148,163,184,0.08)] px-4 py-3.5 sm:px-5 sm:py-4 border-b border-border/60 flex items-center gap-3">
                  ...
                  <h4 className="text-[14px] sm:text-[15px] font-bold text-(--heading)">Finding Acceleration</h4>
                </div>
                <div className="p-4 sm:p-6">
                  ...
                  <ContrastText className="bg-[#17A546]/5 rounded-lg p-4 sm:p-5 border border-[#17A546]/20">
                    <h5 className="text-[12px] sm:text-[13px] font-bold uppercase tracking-wider mb-2.5 sm:mb-3">Solution</h5>
                    <div className="text-[13px] sm:text-[14.5px] space-y-1.5 sm:space-y-2">
                      <p>Given: u = 0 m/s, v = 20 m/s, t = 10 s</p>
                      <p>Using: v = u + at</p>
                      <p>20 = 0 + a(10)</p>
                      <p>10a = 20</p>
                      <p className="font-bold mt-2 sm:mt-3">a = 2 m/s²</p>
                    </div>
                  </ContrastText>
                </div>
              </div>
              ...
              <div className="border border-border/60 rounded-[12px] sm:rounded-2xl overflow-hidden">
                <div className="bg-[rgba(148,163,184,0.08)] px-4 py-3.5 sm:px-5 sm:py-4 border-b border-border/60 flex items-center gap-3">
                  ...
                  <h4 className="text-[14px] sm:text-[15px] font-bold text-(--heading)">Finding Distance</h4>
                </div>
                <div className="p-4 sm:p-6">
                  <p className="text-[14px] sm:text-[15.5px] text-[#475467] mb-5 sm:mb-6">
                    Using the same car from the previous example, calculate the distance covered in those 10 seconds.
                  </p>
                  <ContrastText className="bg-amber-50 rounded-lg p-4 sm:p-5 border border-amber-200/50">
                    <h5 className="text-[12px] sm:text-[13px] font-bold uppercase tracking-wider mb-2.5 sm:mb-3">Solution</h5>
                    <div className="text-[13px] sm:text-[14.5px] space-y-1.5 sm:space-y-2">
                      <p>Using: s = ut + ½at²</p>
                      <p>s = (0)(10) + ½(2)(10)²</p>
                      <p>s = 0 + (1)(100)</p>
                      <p className="font-bold mt-2 sm:mt-3">s = 100 meters</p>
                    </div>
                  </ContrastText>
                </div>
              </div>
          ...
          <section className="bg-(--card) rounded-[12px] sm:rounded-2xl border border-[#17A546]/20 shadow-[0_8px_30px_-4px_rgba(23,165,70,0.08)] p-5 sm:p-10 mb-8">
            <div className="flex items-center justify-between mb-6 sm:mb-8 pb-4 border-b border-border">
              <div className="flex items-center gap-3">
                ...
                <h2 className="text-[19px] sm:text-[22px] font-bold text-(--heading)">Practice Questions</h2>
              </div>
            ...
            <div className="text-center py-6 sm:py-10">
              ...
              <h3 className="text-[17px] sm:text-lg font-bold text-(--heading) mb-2">Ready to test your knowledge?</h3>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-3 sm:gap-4 pt-4 sm:pt-6 border-t border-border/60">
            <Link href="#" className="w-full sm:w-auto">
              <Button variant="outline" className="w-full sm:w-auto h-auto px-5 sm:px-6 py-3 sm:py-4 rounded-lg sm:rounded-lg border-border text-(--muted) hover:text-(--heading) font-semibold text-[14px] sm:text-[15px]">
