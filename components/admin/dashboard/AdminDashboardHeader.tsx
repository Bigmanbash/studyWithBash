    ...
    <header className="sticky top-0 z-30 bg-white/80 backdrop-blur-md border-b border-neutral-100">
      <div className="flex items-center justify-between h-16 px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-3">
          {/* Search */}
          <div
            className={`hidden sm:flex items-center bg-neutral-50 rounded-xl px-4 py-2 gap-2 border transition-colors duration-200 ${
              searchFocused
          ...
          >
            <div className="h-8 w-8 rounded-full bg-[#030E36] flex items-center justify-center text-white font-bold text-xs">
              A
            </div>
